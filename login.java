...
public class login extends JFrame implements ActionListener
{
	...
	ImageIcon ok_default=new ImageIcon("icons/sign in.gif");
	//ImageIcon ok_mouseover=new ImageIcon("icons/ok_button1.gif");
	ImageIcon clear_default=new ImageIcon("icons/clear.gif");
	ImageIcon img_rotator=new ImageIcon("icons/rotator.gif");
